...
import { getArrayFromLocal, getCountFromLocal } from "../lib/localStorage";
  ...
  return (
    <div className="main">
      <div className="main__content1">
        <Button
          theme={ButtonTheme.LIKE}
          sizeLike={ButtonSizeLike.M}
          moveClick={decrementIndex}
        >
          <img
            className="hearth"
            src={breakhearth}
